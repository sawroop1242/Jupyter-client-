      ...
      <div className="w-full max-w-xl">
        ...
        <div className="mt-6">
            ...
            <div className="bg-slate-800 rounded-lg shadow-lg border border-slate-700/50 p-4 max-h-[50vh] overflow-y-auto">
               {servers.length === 0 ? (
                <p className="text-center text-slate-500 py-8">No saved servers. Add one to get started!</p>
               ) : (
                <ul className="space-y-3">
                    {servers.map(server => (
                        <li key={server.id} className="bg-slate-900/50 p-3 rounded-md flex items-center justify-between border border-slate-700 hover:border-sky-500/50 hover:bg-slate-700/30 transition-all duration-200">
                           ...
                           <div className="flex items-center space-x-1 flex-shrink-0">
                             ...
                             <button 
                                ...
                                className="bg-sky-600 hover:bg-sky-700 text-white font-bold text-sm py-1.5 px-4 rounded-md transition duration-150 disabled:bg-slate-600 disabled:cursor-wait flex items-center w-28 justify-center"
                             >
