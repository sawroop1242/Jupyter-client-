  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col">
      <header className="sticky top-0 z-30 flex items-center justify-between p-3 bg-slate-900/70 backdrop-blur-md border-b border-slate-700">
        ...
        <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className={`flex items-center space-x-2 w-28 justify-center font-bold py-2 px-3 rounded-md transition-all duration-150 ${
                saveSuccess
                  ? 'bg-green-600'
      ...
      <main className="flex-1 p-1 md:p-4 lg:px-8 xl:px-16 overflow-y-auto">
        ...
        {notebook && (
          <div className="max-w-4xl mx-auto bg-slate-800 rounded-lg shadow-lg border border-slate-700/50">
