...
const FileItem: React.FC<{ item: IContent; onClick: () => void }> = ({ item, onClick }) => {
  ...
  return (
    <li
      onClick={onClick}
      className="flex items-center p-3 hover:bg-sky-900/40 rounded-md cursor-pointer transition-colors duration-150 space-x-4 border border-transparent"
    >
...
export const FileBrowser: React.FC<FileBrowserProps> = ({ server, onFileSelect, onDisconnect }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col p-2 md:p-4">
